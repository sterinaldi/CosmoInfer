...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "volume_reconstruction.utils.cumulative",
        "sources": [
            "volume_reconstruction/utils/cumulative.pyx"
        ]
    },
    "module_name": "volume_reconstruction.utils.cumulative"
}
END: Cython Metadata */
...
#define __PYX_HAVE__volume_reconstruction__utils__cumulative
#define __PYX_HAVE_API__volume_reconstruction__utils__cumulative
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* "volume_reconstruction/utils/cumulative.pyx":8
 * DTYPE = np.float
 * 
 ...
 */
typedef __pyx_t_5numpy_float_t __pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'volume_reconstruction.utils.cumulative' */
static CYTHON_INLINE double __pyx_f_21volume_reconstruction_5utils_10cumulative_log_add(double, double); /*proto*/
static PyObject *__pyx_f_21volume_reconstruction_5utils_10cumulative_fast_log_cumulative(PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "volume_reconstruction.utils.cumulative"
extern int __pyx_module_is_main_volume_reconstruction__utils__cumulative;
int __pyx_module_is_main_volume_reconstruction__utils__cumulative = 0;

/* Implementation of 'volume_reconstruction.utils.cumulative' */
...
static PyObject *__pyx_pf_21volume_reconstruction_5utils_10cumulative_fast_log_cumulative(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_f); /* proto */
...
/* "volume_reconstruction/utils/cumulative.pyx":10
 * ctypedef np.float_t DTYPE_t
 * 
 * cdef inline double d_max(double a, double b): return a if a >= b else b             # <<<<<<<<<<<<<<
 * 
...
static CYTHON_INLINE double __pyx_f_21volume_reconstruction_5utils_10cumulative_d_max(double __pyx_v_a, double __pyx_v_b) {
  double __pyx_r;
...
/* "volume_reconstruction/utils/cumulative.pyx":12
 * cdef inline double d_max(double a, double b): return a if a >= b else b
 * 
 * cdef inline double log_add(double x, double y): return x+log(1+exp(y-x)) if x >= y else y+log(1+exp(x-y))             # <<<<<<<<<<<<<<
 * 
...
static CYTHON_INLINE double __pyx_f_21volume_reconstruction_5utils_10cumulative_log_add(double __pyx_v_x, double __pyx_v_y) {
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  __Pyx_RefNannySetupContext("log_add", 0);
...
/* "volume_reconstruction/utils/cumulative.pyx":14
 * cdef inline double log_add(double x, double y): return x+log(1+exp(y-x)) if x >= y else y+log(1+exp(x-y))
 * 
 * cpdef fast_log_cumulative(np.ndarray[DTYPE_t, ndim=1]  f):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_21volume_reconstruction_5utils_10cumulative_1fast_log_cumulative(PyObject *__pyx_self, PyObject *__pyx_v_f); /*proto*/
static PyObject *__pyx_f_21volume_reconstruction_5utils_10cumulative_fast_log_cumulative(PyArrayObject *__pyx_v_f, CYTHON_UNUSED int __pyx_skip_dispatch) {
  size_t __pyx_v_n;
  ...
  __Pyx_RefNannySetupContext("fast_log_cumulative", 0);
  ...
  __pyx_pybuffernd_f.rcbuffer = &__pyx_pybuffer_f;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_f.rcbuffer->pybuffer, (PyObject*)__pyx_v_f, &__Pyx_TypeInfo_nn___pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 14, __pyx_L1_error)
  }
  ...
  /* "volume_reconstruction/utils/cumulative.pyx":15
 * 
 * cpdef fast_log_cumulative(np.ndarray[DTYPE_t, ndim=1]  f):
 *     cdef size_t n = f.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[DTYPE_t, ndim=1] h = np.zeros(n, dtype=DTYPE)
 ...
 */
  ...
  /* "volume_reconstruction/utils/cumulative.pyx":16
 * cpdef fast_log_cumulative(np.ndarray[DTYPE_t, ndim=1]  f):
 *     cdef size_t n = f.shape[0]
 *     cdef np.ndarray[DTYPE_t, ndim=1] h = np.zeros(n, dtype=DTYPE)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_FromSize_t(__pyx_v_n); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_h.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "volume_reconstruction/utils/cumulative.pyx":18
 *     cdef np.ndarray[DTYPE_t, ndim=1] h = np.zeros(n, dtype=DTYPE)
 * 
 *     h[0] = f[0]             # <<<<<<<<<<<<<<
 *     for i in range(1,n):
 ...
 */
  ...
  __pyx_t_7 = -1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_pybuffernd_f.diminfo[0].shape;
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_pybuffernd_f.diminfo[0].shape)) __pyx_t_7 = 0;
  ...
  } else if (unlikely(__pyx_t_8 >= __pyx_pybuffernd_h.diminfo[0].shape)) __pyx_t_7 = 0;
  if (unlikely(__pyx_t_7 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_7);
    __PYX_ERR(0, 18, __pyx_L1_error)
  }
  *__Pyx_BufPtrStrided1d(__pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t *, __pyx_pybuffernd_h.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_h.diminfo[0].strides) = (*__Pyx_BufPtrStrided1d(__pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t *, __pyx_pybuffernd_f.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_f.diminfo[0].strides));

  /* "volume_reconstruction/utils/cumulative.pyx":19
 * 
 *     h[0] = f[0]
 *     for i in range(1,n):             # <<<<<<<<<<<<<<
 *         h[i] = log_add(h[i-1],f[i])
 *     return h-h[-1]
 */
  __pyx_t_4 = __Pyx_PyInt_FromSize_t(__pyx_v_n); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_1, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (likely(PyList_CheckExact(__pyx_t_4)) || PyTuple_CheckExact(__pyx_t_4)) {
    ...
    __pyx_t_9 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_10 = Py_TYPE(__pyx_t_1)->tp_iternext; if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  for (;;) {
    if (likely(!__pyx_t_10)) {
      if (likely(PyList_CheckExact(__pyx_t_1))) {
        ...
        __pyx_t_4 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_9); __Pyx_INCREF(__pyx_t_4); __pyx_t_9++; if (unlikely(0 < 0)) __PYX_ERR(0, 19, __pyx_L1_error)
        #else
        __pyx_t_4 = PySequence_ITEM(__pyx_t_1, __pyx_t_9); __pyx_t_9++; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        #endif
      } else {
        if (__pyx_t_9 >= PyTuple_GET_SIZE(__pyx_t_1)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_4 = PyTuple_GET_ITEM(__pyx_t_1, __pyx_t_9); __Pyx_INCREF(__pyx_t_4); __pyx_t_9++; if (unlikely(0 < 0)) __PYX_ERR(0, 19, __pyx_L1_error)
        #else
        __pyx_t_4 = PySequence_ITEM(__pyx_t_1, __pyx_t_9); __pyx_t_9++; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        #endif
    ...
    /* "volume_reconstruction/utils/cumulative.pyx":20
 *     h[0] = f[0]
 *     for i in range(1,n):
 *         h[i] = log_add(h[i-1],f[i])             # <<<<<<<<<<<<<<
 *     return h-h[-1]
 */
    __pyx_t_4 = __Pyx_PyInt_SubtractObjC(__pyx_v_i, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_3 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_h), __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_11 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_11 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_f), __pyx_v_i); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_12 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_12 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyFloat_FromDouble(__pyx_f_21volume_reconstruction_5utils_10cumulative_log_add(__pyx_t_11, __pyx_t_12)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_h), __pyx_v_i, __pyx_t_3) < 0)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "volume_reconstruction/utils/cumulative.pyx":21
 *     for i in range(1,n):
 *         h[i] = log_add(h[i-1],f[i])
 *     return h-h[-1]             # <<<<<<<<<<<<<<
 */
  ...
  } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_h.diminfo[0].shape)) __pyx_t_7 = 0;
  if (unlikely(__pyx_t_7 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_7);
    __PYX_ERR(0, 21, __pyx_L1_error)
  }
  __pyx_t_1 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(__pyx_t_21volume_reconstruction_5utils_10cumulative_DTYPE_t *, __pyx_pybuffernd_h.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_h.diminfo[0].strides))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Subtract(((PyObject *)__pyx_v_h), __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("volume_reconstruction.utils.cumulative.fast_log_cumulative", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_f.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_21volume_reconstruction_5utils_10cumulative_1fast_log_cumulative(PyObject *__pyx_self, PyObject *__pyx_v_f); /*proto*/
static PyObject *__pyx_pw_21volume_reconstruction_5utils_10cumulative_1fast_log_cumulative(PyObject *__pyx_self, PyObject *__pyx_v_f) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("fast_log_cumulative (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_f), __pyx_ptype_5numpy_ndarray, 1, "f", 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  __pyx_r = __pyx_pf_21volume_reconstruction_5utils_10cumulative_fast_log_cumulative(__pyx_self, ((PyArrayObject *)__pyx_v_f));
...
static PyObject *__pyx_pf_21volume_reconstruction_5utils_10cumulative_fast_log_cumulative(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_f) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_f;
  __Pyx_Buffer __pyx_pybuffer_f;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_pybuffernd_f.diminfo[0].strides = __pyx_pybuffernd_f.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_f.diminfo[0].shape = __pyx_pybuffernd_f.rcbuffer->pybuffer.shape[0];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_21volume_reconstruction_5utils_10cumulative_fast_log_cumulative(__pyx_v_f, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"fast_log_cumulative", (PyCFunction)__pyx_pw_21volume_reconstruction_5utils_10cumulative_1fast_log_cumulative, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cumulative(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cumulative},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcumulative(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcumulative(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cumulative(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cumulative(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cumulative(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cumulative' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cumulative(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cumulative", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_volume_reconstruction__utils__cumulative) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "volume_reconstruction.utils.cumulative")) {
      if (unlikely(PyDict_SetItemString(modules, "volume_reconstruction.utils.cumulative", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "volume_reconstruction/utils/cumulative.pyx":2
 ...
 */
  ...
  /* "volume_reconstruction/utils/cumulative.pyx":6
 * from libc.math cimport log,exp
 * 
 * DTYPE = np.float             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "volume_reconstruction/utils/cumulative.pyx":1
 * from __future__ import division             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init volume_reconstruction.utils.cumulative", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init volume_reconstruction.utils.cumulative");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
